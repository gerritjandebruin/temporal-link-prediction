...
def get_edgelist_and_instances(
  ...
  edgelist_mature = load(
    os.path.join(path, 'edgelist_mature.pkl'), verbose=verbose)
  instances_sampled = load(
    os.path.join(path, 'instances_sampled.npy'), verbose=verbose)
